...
interface HardLimits {
    companion object {
        ...
        val LIMIT_MIN_BG = 54.0..180.2
        val LIMIT_MAX_BG = 54.0..200.0
        val LIMIT_TARGET_BG = 54.0..200.0
        ...
        val LIMIT_TEMP_MIN_BG = 54.0..180.16
        val LIMIT_TEMP_MAX_BG = 54.0..270.0
        val LIMIT_TEMP_TARGET_BG = 54.0..200.0
        val LIMIT_DIA = mapOf(
