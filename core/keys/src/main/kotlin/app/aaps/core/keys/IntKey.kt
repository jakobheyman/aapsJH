...
enum class IntKey(
    ...
    ApsMaxSmbFrequency(R.string.key_openaps_smb_interval, 3, 0, 10, defaultedBySM = true),
    //ApsMaxSmbFrequency(R.string.key_openaps_smb_interval, 3, 1, 10, defaultedBySM = true),
    ApsMaxMinutesOfBasalToLimitSmb(R.string.key_openaps_smb_max_minutes, 30, 15, 240, defaultedBySM = true),
    //ApsMaxMinutesOfBasalToLimitSmb(R.string.key_openaps_smb_max_minutes, 30, 15, 120, defaultedBySM = true),
    ApsUamMaxMinutesOfBasalToLimitSmb(R.string.key_openaps_uam_smb_max_minutes, 30, 15, 240, defaultedBySM = true),
