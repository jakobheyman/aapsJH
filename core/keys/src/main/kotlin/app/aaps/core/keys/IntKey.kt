...
enum class IntKey(
    ...
    ApsMaxSmbFrequency("smbinterval", 3, 0, 10, defaultedBySM = true, dependency = BooleanKey.ApsUseSmb),
    //ApsMaxSmbFrequency("smbinterval", 3, 1, 10, defaultedBySM = true, dependency = BooleanKey.ApsUseSmb),
    ApsMaxMinutesOfBasalToLimitSmb("smbmaxminutes", 30, 15, 240, defaultedBySM = true, dependency = BooleanKey.ApsUseSmb),
    //ApsMaxMinutesOfBasalToLimitSmb("smbmaxminutes", 30, 15, 120, defaultedBySM = true, dependency = BooleanKey.ApsUseSmb),
    ApsUamMaxMinutesOfBasalToLimitSmb("uamsmbmaxminutes", 30, 15, 240, defaultedBySM = true, dependency = BooleanKey.ApsUseSmb),
