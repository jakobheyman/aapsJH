...
open class OpenAPSAutoISFPlugin @Inject constructor(
    ...
    override fun invoke(initiator: String, tempBasalFallback: Boolean) {
        ...
        val oapsProfile = OapsProfileAutoIsf(
            ...
            enable_pp_ISF_always = enable_pp_ISF_always,
            ...
            enableSMB_EvenOn_OddOff = enableSMB_EvenOn_OddOff,
    ...
    fun interpolate(xdata: Double, type: String): Double {   // interpolate ISF behaviour based on polygons defining nonlinear functions defined by value pairs for ...
        ...
        if (type == "bg") {
            ...
            polyX = arrayOf(50.0, 60.0, 70.0, 80.0, 90.0, 100.0, 110.0, 120.0, 130.0, 140.0, 150.0, 160.0, 170.0, 180.0, 190.0, 200.0, 210.0, 220.0, 230.0, 240.0, 250.0)
            polyY = arrayOf(-0.5, -0.5, -0.375, -0.25, -0.125, 0.0, 0.125, 0.25, 0.375, 0.5, 0.625, 0.75, 0.875, 1.0, 1.125, 1.25, 1.375, 1.5, 1.625, 1.75, 1.75)
